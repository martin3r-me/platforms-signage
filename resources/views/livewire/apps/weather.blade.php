<x-ui-page>
    ...
    <x-ui-page-container>
        <div class="max-w-2xl mx-auto space-y-6" x-data="{
            ...
            <x-signage-panel icon="eye" title="Vorschau" subtitle="Design & Farbschema live ansehen (nutzt Beispiel-Ort, bis gespeichert)">
                <div class="p-4">
            ...
            <x-signage-panel icon="cloud" title="Wetter" subtitle="Live-Wetter & 7-Tage-Vorhersage (Open-Meteo, kein API-Key)">
